...
func Leaderboard(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "leaderboardaix.html", gin.H{"listusers": listusers})
}
...
func ReadJsonUserXp() {
	// Open our jsonFile
	jsonFile, err := os.Open("assets/json/usersaix.json")
	// if we os.Open returns an error then handle it
	if err != nil {
		fmt.Println(err)
	}

	fmt.Println("Successfully Opened usersaix.json")
